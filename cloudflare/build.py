...
def main():
    ...
    # 1. Install dependencies from cloudflare/requirements.txt into cloudflare/src/
    ...
    # 2. Copy current repo's local ytmusicapi package into cloudflare/src/ytmusicapi
